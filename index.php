...
<div id="sidebar">
    ...
    <ul id="nav-menu">
        <li id="home-page" class="selected"><img src="images/icons/Home.png"><span class="menu-text">Home</span><img
                src="images/menu_arrow.png" class="arrow"/></li>
        <li id="projects-page"><img src="images/icons/Notepad.png"><span class="menu-text">Projects</span><img
                src="images/menu_arrow.png" class="arrow"/></li>
        <li id="blog-page"><img src="images/icons/Pencil.png"><span class="menu-text">Blog</span><img
                src="images/menu_arrow.png" class="arrow"/></li>
        <li id="blog-page"><img src="images/icons/Social Media - Wordpress.png"><span class="menu-text">Wordpress</span><img
                src="images/menu_arrow.png" class="arrow"/></li>
        <li id="projects-page"><img src="images/icons/Social Media - Facebook.png"><span
                class="menu-text">Like Us</span><img src="images/menu_arrow.png" class="arrow"/></li>
        <li id="blog-page"><img src="images/icons/Social Media - RSS Feeds.png"><span
                class="menu-text">RSS Feed</span><img src="images/menu_arrow.png" class="arrow"/></li>
        <li id="blog-page"><img src="images/icons/User - M.png"><span class="menu-text">Contact</span><img
                src="images/menu_arrow.png" class="arrow"/></li>
    </ul>
</div>
<div id="page-wrapper">
